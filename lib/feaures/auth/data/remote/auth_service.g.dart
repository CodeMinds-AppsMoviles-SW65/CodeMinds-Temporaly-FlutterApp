...
class _AuthService implements AuthService {
  ...
  Future<HttpResponse<SignUpResponseDto>> signUp(
      SignUpRequestDto signUpRequestDto) async {
  ...
  Future<HttpResponse<SignInResponseDto>> signIn(
    ...
    final _options = _setStreamType<HttpResponse<SignInResponseDto>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<RefreshTokenResponseDto>> refreshToken(
    ...
    final _options =
        _setStreamType<HttpResponse<RefreshTokenResponseDto>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
